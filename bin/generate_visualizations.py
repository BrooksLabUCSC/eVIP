...
def main():
    ...
    run_main(inp_dir=args.inp_dir, use_c_pval=args.use_c_pval)

def run_main(inp_dir, use_c_pval):
    ...
    # This loads in the data used in the overall impact section into a pandas dataframe
